...
.proc player1_hittest_x
    lda #.LOBYTE(player1_posvel)
    sta actor_pointer_lo
    lda #.HIBYTE(player1_posvel)
...
.proc player1_check_controller_x
    check_left:
        ...
        and #DPAD_LEFT
        beq check_right
        ldx player1_posvel+2
        dex
        stx player1_posvel+2
        jmp exit
...
.proc player1_check_controller_y
    check_up:
        ...
        and #DPAD_UP
        beq check_down
        ldx player1_posvel+3
        dex
        stx player1_posvel+3
        jmp exit
...
.proc player1_apply_velocity_x
    ...
    prevent_exceeding_max:
        lda #1
        sta player1_posvel+2 ; vel_x

    apply:
        lda player1_posvel   ; pos_x
        clc
        adc player1_posvel+2 ; vel_x
        sta player1_posvel   ; pos_x
        jmp exit
...
.proc player1_apply_velocity_y
    ...
    prevent_exceeding_max:
        lda #1
        sta player1_posvel+3 ; vel_y

    apply:
        lda player1_posvel+1 ; pos_y
        clc
        adc player1_posvel+3 ; vel_y
        sta player1_posvel+1 ; pos_y
        jmp exit
